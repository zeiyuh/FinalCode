...
void loop() { 
        ...
        } else if (realHour == storedHour_2 && realMinute == storedMinute_2 && m == alarmMonth_2 && d == alarmDay_2 && yr == alarmYear_2) { //alarm#2
          alarm = true;
          Blynk.logEvent("schedule_reminder");
        ...
        } else if (realHour == storedHour_3 && realMinute == storedMinute_3 && m == alarmMonth_3 && d == alarmDay_3 && yr == alarmYear_3) { //alarm#3
          alarm = true;
          Blynk.logEvent("schedule_reminder");
        ...
        } else if (realHour == storedHour_4 && realMinute == storedMinute_4 && m == alarmMonth_4 && d == alarmDay_4 && yr == alarmYear_4) { //alarm#4
          alarm = true;
          Blynk.logEvent("schedule_reminder");
        ...
        } else if (off_1 == true && off_2 == true && off_3 == true && off_4 == true){
                  alarm = true;
                  LED_ON();
                  soundAlarm();
...
void BPMDISP(){ 
                uint32_t period_2 = 0.15 * 60000L;       // 15 loop
                for( uint32_t tStart_2 = millis();  (millis()-tStart_2) < period_2;  ){
                   ...
                   timedisplay();
                     ...
                     uint32_t pulseperiod_2 = 0.15 * 60000L;       // 15 loop
